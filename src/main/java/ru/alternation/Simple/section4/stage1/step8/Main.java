package ru.alternation.Simple.section4.stage1.step8;
...
/*
Exception in thread "main" java.lang.ClassCastException: ru.alternation.Simple.section4.stage1.step8.Main$B cannot be cast to ru.alternation.Simple.section4.stage1.step8.Main$A
	at ru.alternation.Simple.section4.stage1.step8.Main.method1(Main.java:30)
	at ru.alternation.Simple.section4.stage1.step8.Main.main(Main.java:22)
